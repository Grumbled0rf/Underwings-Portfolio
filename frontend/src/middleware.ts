...
export const onRequest = defineMiddleware(async (context, next) => {
  ...
  if (contentType.includes('text/html')) {
    const csp = [
      `default-src 'self'`,
      `script-src 'self' 'nonce-${nonce}' 'strict-dynamic' https://d3e54v103j8qbb.cloudfront.net https://cdn.prod.website-files.com https://js-eu1.hs-scripts.com https://js.hs-scripts.com https://js.hsforms.net https://js-eu1.hsforms.net https://js.hs-banner.com https://js.hs-analytics.net https://js.usemessages.com https://assets.calendly.com https://challenges.cloudflare.com https://www.googletagmanager.com https://www.google-analytics.com`,
      `style-src 'self' 'unsafe-inline' https://assets.calendly.com https://fonts.googleapis.com`,
      `img-src 'self' data: blob: https://cdn.brandfetch.io https://www.offsec.com https://track.hubspot.com https://assets.calendly.com https://www.google-analytics.com https://www.googletagmanager.com`,
      `font-src 'self' data: https://assets.calendly.com https://fonts.gstatic.com`,
      `media-src 'self' blob:`,
      `connect-src 'self' https://api.hsforms.com https://api-eu1.hsforms.com https://forms.hsforms.com https://track.hubspot.com https://calendly.com https://api.anthropic.com https://challenges.cloudflare.com https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com`,
